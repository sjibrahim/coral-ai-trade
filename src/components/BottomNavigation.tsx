...
const BottomNavigation = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-gray-800/95 backdrop-blur-xl border-t border-gray-600/30">
      <div className="flex items-center justify-around py-3 px-4">
        {navItems.map((item, index) => (
          ...
          >
            {item.isCenter ? (
              <div className="w-16 h-16 bg-teal-400 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 -mt-8">
                <img 
                  src={item.iconBase64} 
                  alt={item.label}
              ...
              <div className={cn(
                ...
                <img 
                  ...
                  className={cn(
                    ...
                    isActive(item.path) ? "brightness-0 invert sepia saturate-[500%] hue-rotate-[140deg]" : "brightness-0 invert opacity-60"
                  )}
                />
              </div>
            )}
