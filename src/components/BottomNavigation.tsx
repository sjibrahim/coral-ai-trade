              ...
              <div className={cn(
                ...
                <img 
                  ...
                  className={cn(
                    ...
                    isActive(item.path) ? "filter brightness-0 invert" : "filter brightness-0 invert opacity-60"
                  )}
                />
              </div>
            )}
