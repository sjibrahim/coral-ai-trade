        ...
        <div className="p-6 pb-20">
          ...
          <div className="bg-slate-900/50 backdrop-blur-xl rounded-2xl p-6 border border-slate-700/50">
            <form onSubmit={handleRegister} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none">
                    <span className="text-sm text-slate-400 border-r border-slate-600 pr-3 mr-3">+91</span>
                  </div>
                  <Input
                    id="phone"
                    name="phone"
                    ...
                    className="h-12 pl-16 pr-12 bg-slate-800/50 border-slate-600 focus:border-blue-400 text-white placeholder:text-slate-500 rounded-xl"
                    maxLength={10}
                    required
                    inputMode="numeric"
                    pattern="[0-9]*"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="h-12 pl-4 pr-12 bg-slate-800/50 border-slate-600 focus:border-blue-400 text-white placeholder:text-slate-500 rounded-xl"
                    required
                  />
                  <div className="absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none">
              ...
              {/* Referral Code Input */}
              <div className="space-y-2">
                <Label htmlFor="referral_code" className="text-sm font-medium text-white">
              ...
              <Button 
                type="submit" 
                className="w-full h-12 text-base font-semibold bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 mt-6"
