...
const ProfilePage = () => {
  ...
  // Get VIP badge variant based on rank - now more attractive
  const getVipBadge = () => {
    ...
    if (rank.includes('vip1')) {
      return (
        <button 
          ...
          className="group relative overflow-hidden bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-600 text-white px-3 py-1.5 rounded-full border-2 border-amber-300 hover:from-amber-600 hover:to-yellow-600 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-amber-500/30"
        >
          <div className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          <div className="relative flex items-center gap-1.5">
            <Crown className="w-3.5 h-3.5 animate-pulse" />
            <span className="text-xs font-bold tracking-wide">VIP1</span>
    ...
    <MobileLayout>
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-green-50 relative overflow-hidden">
        ...
        <div className="px-4 py-4 space-y-4 relative z-10 pb-24">
          ...
          {/* Quick Actions - 3 in one row with smaller fonts */}
          <Card className="bg-white/90 backdrop-blur-sm border border-gray-200/50 shadow-lg">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm flex items-center gap-2">
              ...
              <div className="grid grid-cols-3 gap-3">
                {quickActions.map((action, idx) => (
                  <button
                    ...
                    className="group p-2.5 rounded-xl bg-gradient-to-br from-gray-50 to-white hover:from-gray-100 hover:to-gray-50 transition-all duration-300 hover:scale-105 hover:shadow-md border border-gray-200/50"
                  >
                    <div className={cn(
                ...
                <div className="space-y-2">
                  {category.items.map((item, idx) => (
                    <button
                      ...
                      className="w-full flex items-center gap-3 p-2.5 rounded-xl hover:bg-gray-50 transition-all duration-300 hover:shadow-sm border border-transparent hover:border-gray-200 group"
                    >
                      <div className={cn(
          ...
          <Card className="bg-red-50/80 backdrop-blur-sm border border-red-200/50 shadow-lg">
            <CardContent className="p-3">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 p-2.5 rounded-xl bg-gradient-to-r from-red-500 to-red-600 text-white hover:from-red-600 hover:to-red-700 transition-all duration-300 hover:shadow-lg"
              >
