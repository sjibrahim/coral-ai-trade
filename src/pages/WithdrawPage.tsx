  ...
  return (
    <MobileLayout showBackButton title="Withdrawal">
      <div className="flex flex-col h-full pb-4 px-4 max-w-md mx-auto">
        {/* Balance */}
        <div className="glass-card rounded-xl p-5 mb-6 shadow-lg border border-border/40 bg-background/70 backdrop-blur-sm">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="bg-background/70 rounded-xl p-4 border border-border/40 backdrop-blur-sm shadow-lg">
