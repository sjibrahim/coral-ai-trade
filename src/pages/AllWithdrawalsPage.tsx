...
import { ArrowDownCircle, IndianRupee, Wallet, Clock, Check, X, Receipt, AlertTriangle } from "lucide-react";
      ...
      <div className="p-4 space-y-4 pb-20 animate-fade-in">
        {isLoading ? (
                    ...
                    <div className="rounded-lg bg-[#14161f] p-4 mb-4">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="rounded-md bg-[#1c1e29] p-3">
                          <p className="text-xs text-gray-500 mb-1">Fee (2%)</p>
                          {isUsdt ? (
                            <div>
          ...
          <div className="bg-[#1c1e29] rounded-xl p-8 border border-[#2a2d3a] text-center mt-8">
            ...
            <p className="text-gray-400 mb-4">No withdrawal records found.</p>
          </div>
        )}
      </div>
    </MobileLayout>
